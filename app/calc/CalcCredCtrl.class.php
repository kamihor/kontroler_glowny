...
require_once $conf->root_path.'/app/calc/CalcCredForm.class.php';
require_once $conf->root_path.'/app/calc/CalcCredResult.class.php';
...
$smarty->display($conf->root_path.'/app/calc/calc_cred.tpl');
}
